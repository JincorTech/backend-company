...
class CompanyMyCest
{
    ...
    public function updateSuccessWithURLWithoutSchema(ApiTester $I)
    {
        $I->wantTo('Update my company as company admin and receive success response (URL without schema)');
