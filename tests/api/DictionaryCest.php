...
class DictionaryCest
{
    ...
    public function country(ApiTester $I)
    {
        ...
        $I->canSeeResponseContains('{"data":[{"id":"c699fc1a-ec7f-4021-9102-31ff03c5624a","alpha2":"RU","name":"\u0420\u043e\u0441\u0441\u0438\u044f","locale":"ru"},{"id":"5f2bef92-a8ac-4061-a5c5-5dbabbb328d5","alpha2":"US","name":"\u0421\u0428\u0410","locale":"ru"}]}');
    }
